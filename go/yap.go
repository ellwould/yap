...
func reloadButton(w http.ResponseWriter, urlPath string, buttonCSS string) {
	fmt.Fprintf(w, "<th><a href=\"/"+urlPath+"\" class=\"button-general "+buttonCSS+"\">&nbsp &#129093 &nbsp</a>&nbsp</th>")
}
...
func messageBox(w http.ResponseWriter, errorType string, headerCSS string, buttonCSS string) {
	...
	if errorType == "email_error" {
		...
		fmt.Fprintf(w, "    <a href=\"/accounting-software\" class=\"button-general button-header "+buttonCSS+"\">Accounting Software Page</a>")
...
func userAccountAdd(w http.ResponseWriter, r *http.Request, dbDetail databaseFunctionParameter, genDetail generalFunctionParameter) {
	...
	if genDetail.userTypeID == "100" {
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th class=\"table-title\";>")
		fmt.Fprintf(w, "      <table style=\"border-style:hidden\">")
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "user-account", "button-user-account")
		fmt.Fprintf(w, "          <th>&nbsp Add a New User Account</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Create Account\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
...
func userAccountEdit(w http.ResponseWriter, r *http.Request, dbDetail databaseFunctionParameter, genDetail generalFunctionParameter) {
	...
	if genDetail.userTypeID == "100" {
		...
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "user-account", "button-user-account")
		fmt.Fprintf(w, "          <th>&nbsp Edit User Account Details</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Update Account\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
...
func userAccountDelete(w http.ResponseWriter, r *http.Request, dbDetail databaseFunctionParameter, genDetail generalFunctionParameter) {
	...
	if genDetail.userTypeID == "100" {
		...
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "user-account", "button-user-account")
		fmt.Fprintf(w, "          <th>&nbsp Delete Individual User Account</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Delete Account\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
		...
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "user-account", "button-user-account")
		fmt.Fprintf(w, "          <th>&nbsp Delete All User Accounts for a PBX</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Delete PBX Accounts\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
		...
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "user-account", "button-user-account")
		fmt.Fprintf(w, "          <th>&nbsp Delete All User Accounts for a Customer</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Delete Customer Accounts\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
...
func customerAdd(w http.ResponseWriter, r *http.Request, dbDetail databaseFunctionParameter, genDetail generalFunctionParameter) {
	...
	if genDetail.userTypeID == "100" {
		...
		fmt.Fprintf(w, "      <table style=\"border-style:hidden\">")
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "customer", "button-customer")
		fmt.Fprintf(w, "          <th>Add a New Customer<br>&nbsp (NOTE: Typing GEN Automatically Generates a Customer ID)</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Create Customer\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
...
func customerEdit(w http.ResponseWriter, r *http.Request, dbDetail databaseFunctionParameter, genDetail generalFunctionParameter) {
	...
	if genDetail.userTypeID == "100" {
		...
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "customer", "button-customer")
		fmt.Fprintf(w, "          <th>&nbsp Edit Customer Details</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Update Customer\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
		...
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "customer", "button-customer")
		fmt.Fprintf(w, "          <th>&nbsp Edit Customer Site Details</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Update Customer Site\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
		...
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "customer", "button-customer")
		fmt.Fprintf(w, "          <th>&nbsp Edit Customer Invoice Details</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Update Customer Invoice\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
...
func customerDelete(w http.ResponseWriter, r *http.Request, dbDetail databaseFunctionParameter, genDetail generalFunctionParameter) {
	...
	if genDetail.userTypeID == "100" {
		...
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "customer", "button-customer")
		fmt.Fprintf(w, "          <th>Delete a Customer<br>&nbsp (NOTE: This Will Delete All User Accounts, PBXs and Exts Part of the Customer)</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Delete Customer\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
...
func pbxAdd(w http.ResponseWriter, r *http.Request, dbDetail databaseFunctionParameter, genDetail generalFunctionParameter) {
	...
	if genDetail.userTypeID == "100" || genDetail.userTypeID == "200" || genDetail.userTypeID == "201" {
		...
		fmt.Fprintf(w, "      <table style=\"border-style:hidden\">")
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "pbx", "button-pbx")
		fmt.Fprintf(w, "          <th>&nbsp Add a New PBX</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Create PBX\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
...
func pbxEdit(w http.ResponseWriter, r *http.Request, dbDetail databaseFunctionParameter, genDetail generalFunctionParameter) {
	...
	if genDetail.userTypeID == "100" || genDetail.userTypeID == "200" || genDetail.userTypeID == "201" {
		...
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "pbx", "button-pbx")
		fmt.Fprintf(w, "          <th>&nbsp Edit PBX Details</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Update PBX\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
		...
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "pbx", "button-pbx")
		fmt.Fprintf(w, "          <th>&nbsp Edit PBX Site Details</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Update PBX Site\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
...
func pbxDelete(w http.ResponseWriter, r *http.Request, dbDetail databaseFunctionParameter, genDetail generalFunctionParameter) {
	...
	if genDetail.userTypeID == "100" || genDetail.userTypeID == "200" {
		...
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "pbx", "button-pbx")
		fmt.Fprintf(w, "          <th>Delete a PBX<br>&nbsp (NOTE: This Will Delete All User Accounts and Exts Part of the Customer)</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Delete PBX\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
...
func extAdd(w http.ResponseWriter, r *http.Request, dbDetail databaseFunctionParameter, genDetail generalFunctionParameter) {
	...
	if genDetail.userTypeID == "100" || genDetail.userTypeID == "200" || genDetail.userTypeID == "201" || genDetail.userTypeID == "300" || genDetail.userTypeID == "301" {
		...
		fmt.Fprintf(w, "      <table style=\"border-style:hidden\">")
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "extension", "button-ext")
		fmt.Fprintf(w, "          <th>&nbsp Add a New Extension</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Create Extension\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
...
func extEdit(w http.ResponseWriter, r *http.Request, dbDetail databaseFunctionParameter, genDetail generalFunctionParameter) {
	...
	if genDetail.userTypeID == "100" || genDetail.userTypeID == "200" || genDetail.userTypeID == "201" || genDetail.userTypeID == "300" || genDetail.userTypeID == "301" {
		...
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "extension", "button-ext")
		fmt.Fprintf(w, "          <th>&nbsp Edit Extension Details</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Update Extension\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
...
func extDelete(w http.ResponseWriter, r *http.Request, dbDetail databaseFunctionParameter, genDetail generalFunctionParameter) {
	...
	if genDetail.userTypeID == "100" || genDetail.userTypeID == "200" || genDetail.userTypeID == "201" || genDetail.userTypeID == "300" {
		...
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "extension", "button-ext")
		fmt.Fprintf(w, "          <th>&nbsp Delete an Extension</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Delete Extension\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
...
func invoiceAdd(w http.ResponseWriter, r *http.Request, dbDetail databaseFunctionParameter, genDetail generalFunctionParameter) {
	...
	if genDetail.userTypeID == "100" {
		...
		fmt.Fprintf(w, "      <table style=\"border-style:hidden\">")
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "invoice", "button-invoice")
		fmt.Fprintf(w, "          <th>Add a New Invoice Item<br>&nbsp (NOTE: YAP PBX & Ext Invoices Cannot Be Created Manually)</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Create Invoice Item\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
...
func invoiceDelete(w http.ResponseWriter, r *http.Request, dbDetail databaseFunctionParameter, genDetail generalFunctionParameter) {
	...
	if genDetail.userTypeID == "100" {
		...
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "invoice", "button-invoice")
		fmt.Fprintf(w, "          <th>Delete an Invoice<br>&nbsp (NOTE: YAP PBX and Ext Invoices Cannot Be Deleted Manually)</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Delete Invoice Item\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
...
func accountingSoftwareSendUpdate(w http.ResponseWriter, r *http.Request, dbDetail databaseFunctionParameter, genDetail generalFunctionParameter, accountingSoftware accountingSoftwareParameter) {
	...
	if genDetail.userTypeID == "100" {
		...
		fmt.Fprintf(w, "      <table style=\"border-style:hidden\">")
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "accounting-software", "button-accounting-software")
		fmt.Fprintf(w, "          <th>&nbsp Send Invoices to Accounting Software</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Send Invoices\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
		...
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "accounting-software", "button-accounting-software")
		fmt.Fprintf(w, "          <th>Update a Customers Details on the Accounting Software</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th class=\"table-title\";>(NOTE: A Customers Details Cannot Be Updated on the Accounting Software<br>If Invoices Are Due to Be Sent & the Invoice Country Name Is Different<br>on the YAP Server Compared to the Accounting Software)</th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <table style=\"border-style:hidden\">")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Update the Customer\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
		...
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "accounting-software", "button-accounting-software")
		fmt.Fprintf(w, "          <th>&nbsp Update All Customer Details on the Accounting Software</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th class=\"table-title\";>(NOTE: Customer Details Cannot Be Updated on the Accounting Software<br>If Invoices Are Due to Be Sent & the Invoice Country Name Is Different<br>on the YAP Server Compared to the Accounting Software)</th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <table style=\"border-style:hidden\">")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Update All Customers\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
...
func serviceProductAdd(w http.ResponseWriter, r *http.Request, dbDetail databaseFunctionParameter, genDetail generalFunctionParameter) {
	...
	if genDetail.userTypeID == "100" {
		...
		fmt.Fprintf(w, "      <table style=\"border-style:hidden\">")
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "service-product", "button-service-product")
		fmt.Fprintf(w, "          <th>Add a New Service/Product<br>&nbsp (NOTE: If the Supplier Does Not Exist, Add a New One Below First)</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Create Service/Product\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
		...
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "service-product", "button-service-product")
		fmt.Fprintf(w, "          <th>&nbsp Add a New Supplier</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Create Supplier\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
		...
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "service-product", "button-service-product")
		fmt.Fprintf(w, "          <th>&nbsp Add a New Sales Tax Rate</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Create Sales Tax Rate\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
...
func serviceProductEdit(w http.ResponseWriter, r *http.Request, dbDetail databaseFunctionParameter, genDetail generalFunctionParameter) {
	...
	if genDetail.userTypeID == "100" {
		...
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "service-product", "button-service-product")
		fmt.Fprintf(w, "          <th>&nbsp Edit Service/Product Details</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Update Service/Product\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
		...
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "service-product", "button-service-product")
		fmt.Fprintf(w, "          <th>&nbsp Edit Supplier Details</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Update Supplier\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
		...
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "service-product", "button-service-product")
		fmt.Fprintf(w, "          <th>&nbsp Edit Sales Tax Rate</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Update Sales Tax Rate\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
...
func serviceProductDelete(w http.ResponseWriter, r *http.Request, dbDetail databaseFunctionParameter, genDetail generalFunctionParameter) {
	...
	if genDetail.userTypeID == "100" {
		...
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "service-product", "button-service-product")
		fmt.Fprintf(w, "          <th>&nbsp Delete a Service/Product</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Delete Service/Product\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
		...
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "service-product", "button-service-product")
		fmt.Fprintf(w, "          <th>&nbsp Delete a Supplier</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Delete Supplier\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
		...
		fmt.Fprintf(w, "        <tr>")
		reloadButton(w, "service-product", "button-service-product")
		fmt.Fprintf(w, "          <th>&nbsp Delete Sales Tax Rate</th>")
		fmt.Fprintf(w, "        </tr>")
		fmt.Fprintf(w, "      </table>")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		...
		fmt.Fprintf(w, "  <tr>")
		fmt.Fprintf(w, "    <th>")
		fmt.Fprintf(w, "      <input type=\"submit\" value=\"Delete Sales Tax Rate\">")
		fmt.Fprintf(w, "    </th>")
		fmt.Fprintf(w, "  </tr>")
		fmt.Fprintf(w, "</table>")
		fmt.Fprintf(w, "</form>")
