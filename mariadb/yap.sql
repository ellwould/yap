...
(
  ...
  `uk_based` ENUM('yes', 'no'),
  `reselling_minutes` ENUM('no', 'yes'),
...
SELECT
  ...
  IFNULL(`customer`.`uk_based`, '') AS 'customer_uk_based',
  ...
  IFNULL(`customer`.`reselling_minutes`, '') AS 'customer_reselling_minutes',
  IFNULL(`customer`.`pbx_limit`, '') AS 'customer_pbx_limit',
  IFNULL(`customer`.`pbx_setup_price`, '') AS 'customer_pbx_setup_price',
  IFNULL(`customer`.`pbx_rental_price`, '') AS 'customer_pbx_rental_price',
  IFNULL(`customer`.`pbx_cease_price`, '') AS 'customer_pbx_cease_price',
  IFNULL(`customer`.`sip_ext_setup_price`, '') AS 'customer_sip_ext_setup_price',
  IFNULL(`customer`.`sip_ext_rental_price`, '') AS 'customer_sip_ext_rental_price',
  IFNULL(`customer`.`sip_ext_cease_price`, '') AS 'customer_sip_ext_cease_price',
  IFNULL(`customer_site_address`.`address_line_1`, '') AS 'customer_site_address_line_1',
  IFNULL(`customer_site_address`.`address_line_2`, '') AS 'customer_site_address_line_2',
  IFNULL(`customer_site_address`.`city_town_village`, '') AS 'customer_site_city_town_village',
  IFNULL(`customer_site_address`.`county_state_region`, '') AS 'customer_site_county_state_region',
...
VALUES (1, 'system', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0);
