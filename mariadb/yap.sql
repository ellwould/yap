...
SELECT DISTINCT
  ...
  IFNULL(`ps_endpoints`.`named_pickup_group`, '(NOT SET)') AS 'named_pickup_group',
  IFNULL(`ps_endpoints`.`media_encryption`, 'no (RECOMMENDED TO ENABLE)') AS 'media_encryption',
  IFNULL(`ps_endpoints`.`ice_support`, 'no (DEFAULT)') AS 'ice_support',
  ...
  IFNULL(`ps_endpoints`.`rewrite_contact`, 'no (DEFAULT)') AS 'rewrite_contact',
  IFNULL(`ps_endpoints`.`rtp_symmetric`, 'no (DEFAULT)') AS 'rtp_symmetric',
  IFNULL(`ps_endpoints`.`force_rport`, 'yes (DEFAULT)') AS 'force_rport',  
  IFNULL(`ps_endpoints`.`permit`, '(NOT SET)') AS 'ip_address_allowed',
  IFNULL(`ps_endpoints`.`allow_transfer`, 'yes (DEFAULT)') AS 'allow_transfer',
  ...
  IFNULL(`ps_endpoints`.`contact_user`, '(NOT SET)') AS 'contact_sip_header_user',
  ...
  IFNULL(`ps_endpoints`.`stir_shaken`, 'no (DEFAULT)') AS 'stir_shaken',
...
VALUES
  ...
  ('Total Inbound Minutes ✆', 'Services', '⊛ YAP (Yet Another PBX) ⊛', NULL),
  ('Total Outbound Minutes ✆', 'Services', '⊛ YAP (Yet Another PBX) ⊛', NULL),
  ('Inbound Minutes Tag ✎', 'Services', '⊛ YAP (Yet Another PBX) ⊛', NULL),
  ('Outbound Minutes Tag ✎', 'Services', '⊛ YAP (Yet Another PBX) ⊛', NULL);
...
'<table>
  ...
  <tr>
    <td style="text-align: left; vertical-align: top;">
      &#9989 Create a Service/Product<br>
      &#9989 View a Service/Product<br>
      &#9989 Update a Service/Product<br>
      &#9989 Delete a Service/Product<br>
    </td>
    <td style="text-align: left; vertical-align: top;">
      &#9989 Create a Supplier<br>
      &#9989 View a Supplier<br>
      &#9989 Update a Supplier<br>
      &#9989 Delete a Supplier<br>
    </td>
  </tr>
  <tr>
    <td style="text-align: left; vertical-align: top;">
      &#9989 Create a Sales Tax Rate<br>
      &#9989 View a Sales Tax Rate<br>
      &#9989 Update a Sales Tax Rate<br>
      &#9989 Delete a Sales Tax Rate<br>
    </td>
    <td style="text-align: left; vertical-align: top;">
...
'<table>
  ...
  <tr>
    <td style="text-align: left; vertical-align: top;">
      &#10060 Create a Service/Product<br>
      &#10060 View a Service/Product<br>
      &#10060 Update a Service/Product<br>
      &#10060 Delete a Service/Product<br>
    </td>
    <td style="text-align: left; vertical-align: top;">
      &#10060 Create a Supplier<br>
      &#10060 View a Supplier<br>
      &#10060 Update a Supplier<br>
      &#10060 Delete a Supplier<br>
    </td>
  </tr>
  <tr>
    <td style="text-align: left; vertical-align: top;">
      &#10060 Create a Sales Tax Rate<br>
      &#10060 View a Sales Tax Rate<br>
      &#10060 Update a Sales Tax Rate<br>
      &#10060 Delete a Sales Tax Rate<br>
    </td>
    <td style="text-align: left; vertical-align: top;">
