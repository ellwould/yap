...
|  | YAP Admin (100) | Group Admin (200) | Group Regular (201) | PBX Admin (300) | PBX Regular (301) | PBX Read Only (302) |  Group Invoice (400) |
|----------------------------------------------|:--:|:--:|:--:|:--:|:--:|:--:|:--:|
...
|  | YAP Admin (100) | Group Admin (200) | Group Regular (201) | PBX Admin (300) | PBX Regular (301) | PBX Read Only (302) | Group Invoice (400) |
| Create a Group Invoice (400) User Account | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ |
| View a Group Invoice (400) User Account | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ |
| Update a Group Invoice (400) User Account | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ |
| Delete a Group Invoice (400) User Account | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ |
|  | YAP Admin (100) | Group Admin (200) | Group Regular (201) | PBX Admin (300) | PBX Regular (301) | PBX Read Only (302) | Group Invoice (400) |
| View Own Group                               | ⛔ | ✅ | ✅ | ⛔ | ⛔ | ⛔ | ❌ |
| Update Own Group                             | ⛔ | ✅ | ❌ | ⛔ | ⛔ | ⛔ | ❌ |
| Delete Own Group                             | ⛔ | ❌ | ❌ | ⛔ | ⛔ | ⛔ | ❌ |
